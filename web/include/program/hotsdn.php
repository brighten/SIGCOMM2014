		...
		<ul data-role="listview"
			...
			class="tprog">
				...
				<?php tprog_add_session(
					"8:15am – 8:30am",
					"Opening ",
					"Aditya Akella and Albert Greenberg");
					?>
				
				<?php tprog_add_session(
					"8:30am – 9:30am",
					"Full talks #1: SDN Architecture and Infrastructure",
					"TBD");
					?>
				...
				<?php tprog_add_session(
					"11:05am – 12:05pm",
					"Full talks #2: Security, Correctness, Debugging",
					"TBD");
					?>
				...
				<?php tprog_add_session(
					"2:15pm-3:15pm",
					"Full talks #3: Efficiency, Scalability",
					"TBD");
					?>
				...
				<?php tprog_add_session(
					"3:30-4:30pm",
					"Full talks #4: New abstractions, Update Mechanisms",
					"TBD");
					?>
